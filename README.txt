...
SERVER DEPLOYMENT WITH CAMERA OCR
Requirements: Node.js 18 or newer and an HTTPS domain or reverse proxy.

1. Clone this repository or upload its complete contents to the server.
2. Run: npm ci --omit=dev
3. Run: npm start
4. Point the HTTPS domain or reverse proxy at the Node service. PORT defaults to 8080 when the hosting platform does not supply it.
